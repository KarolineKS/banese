  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mb-4 sm:mb-6 w-full flex flex-col gap-4 sm:gap-6">
        ...
        <button
          type="submit"
          className="w-full p-2 sm:p-3 text-white rounded-lg transition duration-200 font-semibold text-lg bg-[#00C2A7] hover:bg-[#00A591]"
          style={{
